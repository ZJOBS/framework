...
public class HttpClient {
    ...
    public static void main(String args[]) throws HttpPostRequestEncoder.ErrorDataEncoderException, InterruptedException {
        String url = "http://192.168.1.66:8090/bond-api/game/mktYield/dealEarnRate";
        Map<String, String> getData = new HashMap<String, String>();
        getData.put("bondCode", "12031");
        getData.put("earnRate", "RE");
        getData.put("amoutStr", "12123");
        getData.put("source", "test");
