package zjobs.license.v1.example;
...
import zjobs.license.tool.CommandExecutor;
import zjobs.license.tool.FileUtils;
import zjobs.license.tool.LicenseCommandTool;
import zjobs.license.v1.base.LicenseType;
import zjobs.license.v1.bean.PrivateParam;
import zjobs.license.v1.client.LicenseVerify;
import zjobs.license.v1.client.bean.PublicParam;
import zjobs.license.v1.licensecreator.LicenseCreator;
import zjobs.license.v1.licensecreator.impl.MacLicenseCreator;
...
public class LicenseExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrivateParam privateParam = new PrivateParam(privateStorePass, LicenseCreator.class, "/" + privateStoreDest.getName(), privateAlias, keyPass, subjuct);
