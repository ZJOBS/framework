package zjobs.license.v1.licensecreator.impl;
...
public class MacLicenseCreator extends LicenseCreator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrivateParam param = new PrivateParam("jetyun123", LicenseCreator.class, "/private.store", "default_alias", "jetyun123", "jetyun");
