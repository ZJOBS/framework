package zjobs.license.v1.licensecreator;

import java.io.File;
import java.util.Properties;
import javax.security.auth.x500.X500Principal;
import de.schlichtherle.license.LicenseContent;
import zjobs.license.v1.base.LicenseManagerHolder;
...
public abstract class LicenseCreator {
    ...
    protected final static X500Principal DEFAULTHOLDERANDISSUER = new X500Principal("CN=client,OU=cckj,O=cckj,C=86");
